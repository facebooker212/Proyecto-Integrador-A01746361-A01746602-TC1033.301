...
void empleado() {
  ...
  cout << "Ingrese su talla de uniforme: "; cin >> tallaUniforme;
  cout << "Ingrese su area: (Gerencia/Limpieza) "; cin >> areaCredencial;
  areaUniforme = areaCredencial;
  ...
  Uniforme uniforme{tallaUniforme, colorUniforme, areaUniforme};
  Credencial credencial{diaCredencial, mesCredencial, areaCredencial};
  Empleado empleado{nombreEmpleado, matriculaEmpleado, salarioEmpleado, uniforme, credencial};
  empleado.verNombreE();
  empleado.verMatriculaE();
  empleado.verSalarioE();
  empleado.verUniforme();
